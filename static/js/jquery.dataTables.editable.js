    ...
    $.fn.makeEditable = function (options) {
        ...
        function _fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "submitdata": function (value, settings) {
                    ...
                    // added by chenshu at 2012-04-24
                    var cookie = $.cookie('_xsrf');
                    if (cookie != null) {
                        obj['_xsrf'] = cookie;
                    }
                    return obj;
        ...
        function _fnOnRowAdding(event) {
            if (properties.fnOnAdding()) {
                if (oAddNewRowForm.valid()) {
                    ...
                    var cookie = $.cookie('_xsrf');
                    if (cookie != null) {
                        var inputV = $("<input>").attr("type", "hidden").attr("name", "_xsrf").val(cookie);
                        oAddNewRowForm.append($(inputV));
                    }
        ...
        function _fnOnRowAdded(data) {
            ...
            if (properties.fnOnNewRowPosted(data)) {
                ...
                properties.fnSetRowID($(oTRAdded), data.data[0]);
                //Close the dialog
        ...
        function _fnDeleteRow(id, sDeleteURL) {
            ...
            var cookie = $.cookie('_xsrf');
            if (cookie != null) {
                data = $.extend(properties.oDeleteParameters, { "_xsrf": cookie });
            }
            $.ajax({ 'url': sURL,
        ...
        function _fnOnRowDeleted(response) {
            ...
            if (response == "ok" || response == "" || response.action == 'success') {
